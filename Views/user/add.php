        ...
        <div class="row">
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <input name="lastName" class="form-control" id="lastName" aria-describedby="lastName" value="<?php echo $_POST['lastName'] ?? '' ?>" required>
            ...
            <div class="col">
                <div class="mb-3">
                    ...
                    <?php if (isset($validate['patronymic'])): ?>
                        <div id="patronymic" class="form-text text-danger"> <?php echo $validate['patronymic'][0]; ?>
                </div>
                <?php else: ?>
...
<div class="row">
    ...
    <div class="col">
        ...
        <input type="text" name="phoneNumber" class="form-control" id="phoneNumber" aria-describedby="phoneNumber"
