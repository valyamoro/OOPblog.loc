    ...
    <form action="/comments/add" method="post">
        <div class="mb-3">
            ...
            <?php if (isset($_SESSION['validate']['content'])): ?>
                <div id="content" class="form-text text-danger"> <?php echo $_SESSION['validate']['content'][0]; ?> </div>
                <?php unset($_SESSION['validate']['content']); ?>
            <?php endif; ?>
        </div>
        <button type="submit" name="id_article" value="<?php echo $_GET['id']; ?>" class="btn btn-primary">Add commentary</button>
    </form>
    <?php else: ?>
